...
export const RegisterPage = () => {
    ...
    const [registerSuccessfully,setRegisterSuccessfully] = React.useState<boolean>(false);
    ...
    {
        const client = new RegisterClient(data);
    ...
    return (
        ...
        <div css={css`
            ...
            `}
        >
            {!registerSuccessfully && errors.length > 0 && 
            <div css={css`
                position: fixed;
                display: flex;
            ...
            `}>
                ...
                `}>
                    ...
                    width: 100%;`}>
                        ...
                        >
                            <InputField {...register("Username")} type="text" placeholder="Username"></InputField>
                            ...
                            {registerSuccessfully && 
                                <SuccessfullBox message="Register Successfully"/>
                            }
